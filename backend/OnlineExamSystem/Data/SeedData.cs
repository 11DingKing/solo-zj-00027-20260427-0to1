...
public static class SeedData
{
        ...
        RoleManager<IdentityRole<int>> roleManager)
    {
        ...
        {
            await CreateQuestionsAsync(context);
        }
    ...
    private static async Task CreateQuestionsAsync(AppDbContext context)
    {
        ...
        var singleChoice4 = new Question
        {
            Type = QuestionType.SINGLE_CHOICE,
        ...
        var singleChoice5 = new Question
        {
            Type = QuestionType.SINGLE_CHOICE,
        ...
        var singleChoice6 = new Question
        {
            Type = QuestionType.SINGLE_CHOICE,
        ...
        {
            singleChoice1, singleChoice2, multiChoice1, multiChoice2,
            trueFalse1, trueFalse2, fillBlank1, fillBlank2,
            singleChoice3, singleChoice4, multiChoice3, trueFalse3,
            fillBlank3, singleChoice5, singleChoice6
        };

        context.Questions.AddRange(questions);
        await context.SaveChangesAsync();

        SetCorrectAnswer(singleChoice1);
        SetCorrectAnswer(singleChoice2);
        SetCorrectAnswer(singleChoice3);
        SetCorrectAnswer(singleChoice4);
        SetCorrectAnswer(singleChoice5);
        SetCorrectAnswer(singleChoice6);
        SetCorrectAnswer(trueFalse1);
        SetCorrectAnswer(trueFalse2);
        SetCorrectAnswer(trueFalse3);
        SetMultiChoiceCorrectAnswer(multiChoice1);
        SetMultiChoiceCorrectAnswer(multiChoice2);
        SetMultiChoiceCorrectAnswer(multiChoice3);
    ...
    private static void SetMultiChoiceCorrectAnswer(Question question)
    {
        ...
        if (correctOptions.Any())
        {
            ...
            question.CorrectAnswer = JsonConvert.SerializeObject(correctIds);
        }
    }
