...
import { Spin, Layout, Menu, Typography, Button, Dropdown, Avatar } from 'antd';
import {
  BookOutlined,
  FileTextOutlined,
  BarChartOutlined,
...
const AppContent: React.FC = () => {
  const { isAuthenticated, isTeacher, isStudent, loading } = useAuthContext();
  ...
  return (
    <Routes>
      <Route path="/login" element={
        isAuthenticated ? (
          <Navigate to={isTeacher ? '/teacher/questions' : '/student/exams'} replace />
        ) : (
          <LoginPage />
        )
      } />
      ...
      <Route path="/teacher/exam-papers" element={
        <ProtectedRoute allowedRoles={[UserRole.TEACHER]}>
          <TeacherLayout>
            <ExamPaperManagement />
          </TeacherLayout>
      ...
      <Route path="/teacher/grading/:sessionId" element={
        <ProtectedRoute allowedRoles={[UserRole.TEACHER]}>
          <TeacherLayout>
            <AnswerGrading />
          </TeacherLayout>
